...
const EMO_POOL = w("EMO", [
  ...
  {id:1041,text:"사소한 일에도 신경이 곤두서는 날이 있다.",rev:true},
  {id:1042,text:"기분이 자주 변하는 편이다.",rev:true},
  {id:1043,text:"예상이 어긋나면 표정에 먼저 드러난다.",rev:true},
  {id:1044,text:"작은 자극에도 예민하게 반응한다.",rev:true},
  {id:1045,text:"주변 분위기에 따라 감정 상태가 같이 움직인다.",rev:true},
  {id:1046,text:"감정이 차오르면 말투가 평소와 달라질 때가 있다.",rev:true},
  {id:1047,text:"기분 나쁜 일이 있으면 오래 끌고 간다.",rev:true},
  {id:1048,text:"감정이 솟아오를 때 잠시 자리를 벗어나야 할 때가 있다.",rev:true},
  {id:1049,text:"감정이 얼굴에 바로 드러난다.",rev:true},
  {id:1050,text:"지나가는 말 한마디가 하루 종일 마음에 남기도 한다.",rev:true},
  {id:1051,text:"감정이 격해지면 평소보다 말이 빨라지는 편이다.",rev:true},
  {id:1052,text:"감정이 누적되면 한 번에 표현되곤 한다.",rev:true},
  {id:1053,text:"작은 일에도 크게 반응하는 편이다.",rev:true},
  {id:1054,text:"스트레스에 감정이 먼저 반응한다.",rev:true},
  {id:1055,text:"감정 기복이 있다는 말을 듣는다.",rev:true},
  {id:1056,text:"기분 상태가 행동에 그대로 드러나는 편이다.",rev:true},
  {id:1057,text:"불쾌한 감정을 잘 털어내지 못한다.",rev:true},
  {id:1058,text:"이슈에 빠르게 몰입해 분위기에 영향을 받는다.",rev:true},
...
const RES_POOL = w("RES", [
  ...
  {id:1101,text:"실패한 일을 오래도록 머릿속에서 다시 돌려본다.",rev:true},
  ...
  {id:1106,text:"실패 후에는 다음 도전까지 시간이 필요하다.",rev:true},
  {id:1107,text:"슬럼프에 빠지면 오래간다.",rev:true},
  {id:1108,text:"나쁜 일이 반복될 것 같은 불안이 든다.",rev:true},
  {id:1109,text:"한 번 실패한 분야는 다시 시작하기까지 시간이 든다.",rev:true},
  ...
  {id:1114,text:"회복하는 데 시간이 걸리는 편이라고 스스로 느낀다.",rev:true},
  {id:1115,text:"역경을 겪으면 많이 흔들린다.",rev:true},
  {id:1116,text:"실패가 반복되면 다른 길을 찾아보는 편이다.",rev:true},
  {id:1117,text:"기분이 가라앉으면 평소의 리듬으로 돌아오는 데 시간이 걸린다.",rev:true},
  {id:1118,text:"큰 실망 후에는 며칠간 페이스가 떨어진다.",rev:true},
  {id:1119,text:"어려운 일이 있으면 오래 끌어안고 있다.",rev:true},
  {id:1120,text:"큰 타격을 받으면 회복 루틴을 다시 짜야 한다.",rev:true},
]);
...
const ETH_POOL = w("ETH", [
  ...
  {id:1161,text:"결과가 명확하다면 과정의 디테일은 유연할 수 있다고 본다.",rev:true},
  {id:1162,text:"규정이 불합리하면 지키지 않아도 된다고 생각한다.",rev:true},
  {id:1163,text:"업무에서 얻은 인사이트가 개인 의사결정에 도움이 될 수 있다고 본다.",rev:true},
  ...
  {id:1173,text:"조직 자원을 잠깐 사적으로 쓰는 것까지 엄격할 필요는 없다.",rev:true},
...
const TSK_POOL = w("TSK", [
  ...
  {id:1221,text:"여유 시간이 있어도 마감 직전에 몰아서 하는 편이다.",rev:true},
  {id:1222,text:"어려운 일은 잠시 내려놓고 다른 접근을 찾는 편이다.",rev:true},
  {id:1223,text:"마감이 우선이라 마무리 단계는 빠르게 넘어가기도 한다.",rev:true},
  {id:1224,text:"여러 일이 겹치면 일정이 빠듯해진다.",rev:true},
  {id:1225,text:"전체 그림을 먼저 보다 보니 세부는 나중에 챙긴다.",rev:true},
  {id:1226,text:"흥미가 식으면 다른 방향으로 옮겨가는 편이다.",rev:true},
  {id:1227,text:"반복적인 작업은 집중을 유지하기 위해 환기가 필요하다.",rev:true},
  {id:1228,text:"디테일보다 큰 흐름을 잘 잡는다는 말을 듣는다.",rev:true},
  {id:1229,text:"오래 끌기보다 빠르게 결과를 내는 데 강점이 있다.",rev:true},
  {id:1230,text:"결과물의 범위가 처음 약속과 달라지는 경우가 있다.",rev:true},
  {id:1231,text:"에너지가 떨어지면 잠시 거리를 두고 다시 본다.",rev:true},
  {id:1232,text:"마무리 디테일은 협업자에게 맡기는 편이다.",rev:true},
  {id:1233,text:"책임 범위가 넓을 때 명확한 분담을 먼저 요청한다.",rev:true},
  ...
  {id:1238,text:"완성도보다 속도를 먼저 보는 편이다.",rev:true},
  {id:1239,text:"여러 일이 겹치면 다른 사람의 손을 빌리는 편이다.",rev:true},
  {id:1240,text:"업무 도중 짧은 환기 시간을 자주 갖는다.",rev:true},
]);
...
const FLX_POOL = w("FLX", [
  ...
  {id:1283,text:"내가 이미 결론을 내린 사안에서는 다른 제안을 검토하는 데 시간이 든다.",rev:true},
  ...
  {id:1289,text:"한 번 결정한 것은 끝까지 밀고 가는 편이다.",rev:true},
...
const GRW_POOL = w("GRW", [
  ...
  {id:1341,text:"추가적인 일을 자발적으로 찾기보다 주어진 일에 집중한다.",rev:true},
  {id:1342,text:"지금 위치에서 충분히 의미를 찾는 편이다.",rev:true},
  {id:1343,text:"자기계발은 업무에서 자연스럽게 따라온다고 생각한다.",rev:true},
  {id:1344,text:"현재 수준에 만족한다.",rev:true},
  {id:1345,text:"목표를 세우지 않는 편이다.",rev:true},
  {id:1346,text:"별도 학습보다 실무 경험으로 익히는 편이다.",rev:true},
  {id:1347,text:"배움보다 현상 유지가 편하다.",rev:true},
  {id:1348,text:"확실한 영역에서 안정적으로 일하는 것을 선호한다.",rev:true},
  {id:1349,text:"성장 목표를 거창하게 세우지는 않는 편이다.",rev:true},
  {id:1350,text:"변화보다 안주가 좋다.",rev:true},
  {id:1351,text:"익숙한 영역에서 깊이 있게 일하는 것이 더 효율적이다.",rev:true},
  {id:1352,text:"굳이 더 잘하려고 무리하지 않는 편이다.",rev:true},
  {id:1353,text:"조직이 제시하는 방향을 따라 움직이는 편이다.",rev:true},
  {id:1354,text:"피드백은 받아들이는 데 시간이 필요하다.",rev:true},
  {id:1355,text:"발전보다 휴식이 우선이다.",rev:true},
  {id:1356,text:"거창한 목표보다 일상의 평온이 우선이다.",rev:true},
...
const REL_POOL = w("REL", [
  ...
  {id:1411,text:"친해지는 데 시간이 충분히 필요하다.",rev:true},
  {id:1412,text:"한정된 사람들과 깊게 교류하는 편이 좋다.",rev:true},
  ...
  {id:1420,text:"여러 사람과 동시에 이야기하는 자리는 따라가기 어려울 때가 있다.",rev:true},
]);
...
const EMP_POOL = w("EMP", [
  ...
  {id:1461,text:"감정보다 사실을 먼저 정리하려는 편이다.",rev:true},
  {id:1462,text:"다른 사람 기분을 잘 모르겠다.",rev:true},
  {id:1463,text:"타인의 고민에는 일정 거리를 두는 편이다.",rev:true},
  {id:1464,text:"경험해보지 않은 감정에는 잘 닿지 않는다.",rev:true},
  {id:1465,text:"감정적인 대화가 불편하다.",rev:true},
  {id:1466,text:"사람을 평가할 때 첫인상이 오래 가는 편이다.",rev:true},
  {id:1467,text:"경청이 힘들다.",rev:true},
  {id:1468,text:"상대 입장 정리보다 해결책을 먼저 찾으려 한다.",rev:true},
  {id:1469,text:"감정 읽기를 어려워한다.",rev:true},
  {id:1470,text:"무덤덤한 편이다.",rev:true},
  {id:1471,text:"타인의 고통에 크게 반응하지 않는다.",rev:true},
  {id:1472,text:"타인의 슬픔에는 깊이 빠지지 않으려 한다.",rev:true},
  ...
  {id:1480,text:"감정적인 영역에서 다소 무뎌질 때가 있다.",rev:true},
]);
...
const COM_POOL = w("COM", [
  ...
  {id:1522,text:"팀 활동보다 개인 작업에서 효율이 더 높다.",rev:true},
  {id:1523,text:"개인 성과가 더 중요하다.",rev:true},
  {id:1524,text:"공동 업무에서는 정해진 역할만 명확히 수행하는 편이다.",rev:true},
  ...
  {id:1531,text:"팀 헌신은 개인의 여건이 허락하는 만큼이라고 본다.",rev:true},
  {id:1532,text:"공동 목표에 큰 관심이 없다.",rev:true},
  {id:1533,text:"각자의 영역을 분명히 지키는 것이 효율적이다.",rev:true},
  {id:1534,text:"팀 분위기에 무관심하다.",rev:true},
  {id:1535,text:"동료 일을 돕기 전에 내 일정부터 챙기는 편이다.",rev:true},
  {id:1536,text:"팀 회의가 시간 낭비로 느껴진다.",rev:true},
  {id:1537,text:"협력보다 독립적으로 하고 싶다.",rev:true},
  {id:1538,text:"팀 결정보다 내 판단으로 움직일 때 결과가 좋다.",rev:true},
